...
let boy1 = "Alex"
console.log(typeof boy1);    //string
console.log(boy1 instanceof String)   //false

// using Constructor
let boy2 = new String("Arin")
console.log(typeof boy2);     //object
console.log(boy2 instanceof String)       //true
...
// console.log(sen.replace("friend","enemy"))  //replace only first occurence.
//  use "replaceAll()" to replace all occurence.
